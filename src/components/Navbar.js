export default function Navbar() {
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="home"><img src="public/assets/images/Palmeiras_logo.svg.webp" style = "width: 30px; height: 30px;"></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="home">Homex</a>
                </li>
                <li class="nav-item">
